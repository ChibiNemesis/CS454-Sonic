...
public:
	...
	//void SetOnFinish(const std::function<void(Animator*)> f) { onFinish = f; }
	//void SetOnStart(const std::function<void(Animator*)> f) { onStart = f; }
	//void SetOnAction(const std::function<void(Animator*, const Animation&)> f) { onAction = f; }
